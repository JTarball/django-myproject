...
from wrapper.client import InstagramAPI
...
# ACCESS_TOKEN = get_env_variable("INSTAGRAM_ACCESS_TOKEN")
CLIENT_SECRET = get_env_variable("INSTAGRAM_CLIENT_SECRET")
CONFIG = {
    'client_id': get_env_variable("INSTAGRAM_CLIENT_ID"),
    'client_secret': get_env_variable("INSTAGRAM_CLIENT_SECRET"),
...
class ServiceInstagram(object):
    ...
    def __init__(self):
        self.api = InstagramAPI(client_secret=CLIENT_SECRET)
...
service_instagram = ServiceInstagram()
